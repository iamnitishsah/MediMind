            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center mb-4">
                            ...
                            <span className="ml-2 text-xl font-bold">MediMind</span>
                        </div>
                        <p className="text-gray-300 mb-6 max-w-md">
                            Empowering healthcare professionals with intelligent practice management and AI-powered prescription solutions.
                        </p>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center">
                    <p className="text-gray-400">
                        © 2025 MediMind. All rights reserved. Built with ❤️ for healthcare professionals.
                    </p>
                </div>
            </div>
        </footer>
